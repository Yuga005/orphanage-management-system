...
if (isset($_SESSION['aid'])) {
    ...
    <title>Rejected Adoptions</title>
...
<!--                                    <div class="col-md-3 no-print">
                ...
                <div class="card card-primary no-print">
                    ...
                    <div class="card-header no-print">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">Rejected Adoptions</h3>
    ...
    WHERE orphans.delete_status='0' AND adoptions.delete_status='0' AND adoptions.status='Rejected'");
