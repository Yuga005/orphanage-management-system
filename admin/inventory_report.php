                ...
                <div class="card card-primary no-print">
                    ...
                    <div class="card-header no-print">
                        <div class="d-flex justify-content-between">
                            ...
                            <!-- <a class="btn bg-primary btn-sm" href="inventory.php" style="background:#000 !important;"><i class="nav-icon fas fa-plus"></i> Add Items</a> -->
                                                ...
                                                <label> Donation Type </label>
                                                 <select class="form-control" name="type" id="type">
                                                    <option value="" selected disabled>Select</option>
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $getData['type']; ?>"><?php echo $getData['type']; ?></option>
                                                            <?php }
?>
   ...
   <th>Action</th>
                            ...
                            <tbody>
                                 <?php
                                $records = mysqli_query($con, "SELECT inventory.*, donations.type 
    FROM inventory 
    JOIN donations ON donations.donation_id = inventory.donation_id 
    WHERE donations.delete_status='0' AND inventory.delete_status='0'");
                                ...
                                while ($data = mysqli_fetch_array($records)) {
                                    ...
                                    <tr>
                                        <td><?php echo $x; ?></td>
                                         ...
                                         <td> <?php echo date("d M Y",strtotime(datetime: $data['received_date'])); ?></td>
                                        <td><div class="btn-group">
                                                <a name="edit" href="inventory.php?id=<?php echo $data['item_id']; ?>" class="btn btn-sm btn-success" style="padding: 8px;"><i class="fa fa-edit"></i></a>
                          

                                                <a href="javascript:void(0);" onclick="delRecord(<?php echo $data['item_id'];  ?>)" class="btn btn-sm btn-danger" style="padding: 8px;"><i class="fa fa-trash" aria-hidden="true"></i></a> 
...
$.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
    ...
    let rowName = data[1].trim().toLowerCase();      // column 1 = name
