                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            if (this.responseText == "Deleted") {
                                ...
                                Swal.fire(
                                    'Deleted!',
                                    'Adoption Detail deleted successfully...',
                                    'success',
                                    'OK'
                                ).then((result) => {
                                    location.reload();
                ...
                <div class="card card-primary no-print">
                    ...
                    <div class="card-header no-print">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">View Adoptions</h3>
                    ...
                    <div class="card-body no-print">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $records = mysqli_query($con, "SELECT adoptions.*, orphans.name 
    FROM adoptions 
    JOIN orphans ON orphans.orphan_id = adoptions.orphan_id 
    WHERE orphans.delete_status='0' AND adoptions.delete_status='0'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> <?php if (!empty($data['adoption_date']) && $data['adoption_date'] != "0000-00-00") {
                                                    echo date("d M Y", strtotime(datetime: $data['adoption_date']));
                                                } ?></td>
                                        <td><?php if ($data['status'] == "Pending") { ?><div class="btn-group">
                                                    <a name="edit" href="adoptions.php?id=<?php echo $data['adoption_id']; ?>" class="btn btn-sm btn-success" style="padding: 8px;"><i class="fa fa-edit"></i></a>


                                                    <a href="javascript:void(0);" onclick="delRecord(<?php echo $data['adoption_id'];  ?>)" class="btn btn-sm btn-danger" style="padding: 8px;"><i class="fa fa-trash" aria-hidden="true"></i></a>
