...
<!--                                    <div class="col-md-3 no-print">
                ...
                <div class="card card-primary no-print">
                    ...
                    <div class="card-header no-print">
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="btn bg-primary btn-sm" href="staff.php" style="background:#000 !important;"><i class="nav-icon fas fa-plus"></i> Add Staff</a>
   ...
   <th>Action</th>
                            ...
                            <tbody>
                                 <?php
                                $records = mysqli_query($con, "SELECT staff.*, staff_roles.role_name
    FROM staff 
    JOIN staff_roles ON staff_roles.role_id = staff.role_id 
    WHERE staff.delete_status='0'");
                                    ...
                                    <tr>
                                        <td><?php echo $x; ?></td>
                                         ...
                                         <td><?php echo $data['address']; ?></td>
                                                ...
                                                <input type="checkbox" id="sliderStatus" class="statusCheck" <?php if ($data['status'] == "Active") { ?> checked <?php } ?> value="<?php echo $data['staff_id']; ?>">
                                                <span class="slider round"></span>
                                             </label></td>
                                         <td><?php echo $data['salary']; ?></td>


                                         <td> <?php echo date("d M Y",strtotime(datetime: $data['join_date'])); ?></td>
                                        <td><div class="btn-group">
                                                <a name="edit" href="staff.php?id=<?php echo $data['staff_id']; ?>" class="btn btn-sm btn-success" style="padding: 8px;"><i class="fa fa-edit"></i></a>
                          

                                                <a href="javascript:void(0);" onclick="delRecord(<?php echo $data['staff_id'];  ?>)" class="btn btn-sm btn-danger" style="padding: 8px;"><i class="fa fa-trash" aria-hidden="true"></i></a> 
...
if (isset($_SESSION['exists'])) { ?>
    ...
    ?>
         ...
         buttons: [
            {
                extend: 'copy',
                title: 'Staff List'   // Title inside the file (for PDF/Excel)
            },
            {
                extend: 'csv',
                filename: 'Staff_List_CSV' // Name of CSV file
            },
            {
                extend: 'excel',
                filename: 'Staff_List_Excel', // Name of Excel file
                title: 'Staff_List'
            },
            {
                extend: 'pdf',
                filename: 'Staff_List_PDF',   // Name of PDF file
                title: 'Staff_List'
            },
            {
                extend: 'print',
