                ...
                <div class="card card-primary no-print">
                    ...
                    <div class="card-header no-print">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">View Donors</h3>
                            <a class="btn bg-primary btn-sm" href="donors.php" style="background:#000 !important;"><i class="nav-icon fas fa-plus"></i> Add Donor</a>
                                ...
                                while ($data = mysqli_fetch_array($records)) {
                                    ...
                                    <tr>
                                        <td><?php echo $x; ?></td>
                                         ...
                                         <td> <?php echo date("d M Y",strtotime(datetime: $data['joined_on'])); ?></td>
                                        <td><div class="btn-group">
                                                <a name="edit" href="donors.php?id=<?php echo $data['donor_id']; ?>" class="btn btn-sm btn-success" style="padding: 8px;"><i class="fa fa-edit"></i></a>
                          

                                                <a href="javascript:void(0);" onclick="delRecord(<?php echo $data['donor_id'];  ?>)" class="btn btn-sm btn-danger" style="padding: 8px;"><i class="fa fa-trash" aria-hidden="true"></i></a> 
...
if (isset($_SESSION['exists'])) { ?>
    ...
    ?>
         ...
         buttons: [
            {
                extend: 'copy',
                title: 'Donor List'   // Title inside the file (for PDF/Excel)
            },
            {
                extend: 'csv',
                filename: 'Donor_List_CSV' // Name of CSV file
            },
            {
                extend: 'excel',
                filename: 'Donor_List_Excel', // Name of Excel file
                title: 'Donor_List'
            },
            {
                extend: 'pdf',
                filename: 'Donor_List_PDF',   // Name of PDF file
                title: 'Donor_List'
            },
            {
                extend: 'print',
