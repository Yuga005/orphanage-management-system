...
if (isset($_SESSION['aid'])) {
    ...
    <title>Approved Adoptions</title>
...
<!--                                    <div class="col-md-3 no-print">
                ...
                <div class="card card-primary no-print">
                    ...
                    <div class="card-header no-print">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">Approved Adoptions</h3>
    ...
    WHERE orphans.delete_status='0' AND adoptions.delete_status='0' AND adoptions.status='Approved'");
                                ...
                                while ($data = mysqli_fetch_array($records)) {
                                    ...
                                    <tr>
                                        <td><?php echo $x; ?></td>
                                         ...
                                         <td> <?php echo date("d M Y",strtotime(datetime: $data['adoption_date'])); ?></td>
